// Kairo custom-app SDK public API. Apps `import { View, Text, useState } from "kairo"`.
...
// the "kairo" and "kairo/jsx-runtime" module names on the device engine.
export { jsx, jsxs, jsxDEV, Fragment } from "./jsx-runtime";
export type {
  Style, TextVariant, KElement, KChild, NodeDesc,
} from "./types";

// Ambient `kairo` system API (http/wifi/ble/storage/timer/log) — provided by the
// device at runtime (Plan 37 Fase 4). Declared here so apps get types.
export type { KairoSystem } from "./system";
