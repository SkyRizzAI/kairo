// Ambient `kairo` system API — implemented by the device JS host (Plan 37 Fase 4),
// declared here so custom apps get full TypeScript types. Capability-gated at
// runtime: methods for hardware the board lacks are absent (guard with kairo.device).

export interface KairoSystem {
