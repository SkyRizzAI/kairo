<script lang="ts">
	...
	import { RemoteSession, Key, Power, type ScreenFrame } from '$lib/RemoteSession';
	import { Button } from '$lib/components/ui/button';
	import { Badge } from '$lib/components/ui/badge';
	import { ScrollArea } from '$lib/components/ui/scroll-area';
	import { Power as PowerIcon, RotateCw } from '@lucide/svelte';
...
<div class="flex h-full flex-col">
	...
	<div class="grid flex-1 grid-cols-[auto_1fr] gap-4 overflow-hidden p-4">
		...
		<div class="flex flex-col overflow-hidden">
			...
			<ScrollArea class="flex-1 rounded-md border">
				<div class="p-2 font-mono text-[11px]">
					{#each logs as l, i (i)}
						<div class="py-0.5"><span class="text-muted-foreground">{l.c}</span> {l.m}</div>
					{:else}
