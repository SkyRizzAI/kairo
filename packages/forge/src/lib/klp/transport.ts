// KLP transport abstraction (Forge side).
//
// The remote protocol (KLP) is ALWAYS the same. What changes per connection is
...
export interface ILinkTransport {
	...
	/** Send one already-encoded KLP frame (or framed bytes). */
