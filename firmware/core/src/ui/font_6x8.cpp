...
//
// 95 glyphs covering ASCII 0x20..0x7E. Based on FONT_5X8 with an extra
// right-side column for true fixed-width rendering. Total: 95 × 6 = 570 bytes.
//
// Format: 6 bytes per glyph (one per column, left→right).
// Within each byte: bit 0 = topmost pixel, bit 7 = bottommost (LSB=top).
// Row 7 is always 0 (inter-line spacing).
