...
// Within each byte: bit 0 = topmost pixel, bit 7 = bottommost pixel (LSB=top).
// Based on Adafruit GFX 5×7 font (MIT license), row 7 is always 0 (spacing).
