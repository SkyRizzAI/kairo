...
protected:
    ...
    virtual aether::ui::UiNode* build(aether::ui::NodeArena& arena, AppContext& ctx) = 0;
    ...
    // the modal's widgets; the base is frozen behind it. Use aether::ui::Modal(...) to
    ...
    virtual aether::ui::UiNode* buildModal(aether::ui::NodeArena& arena, AppContext& ctx) {
